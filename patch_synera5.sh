sed -i '4961,5001d' src/components/SyneraMobileView.tsx
sed -i '4960a\
              <div className="flex justify-between items-center bg-slate-900 border border-slate-700 p-3 rounded-2xl mb-2">\
